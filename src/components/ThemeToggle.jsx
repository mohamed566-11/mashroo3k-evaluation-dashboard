...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      <Sun className="w-5 h-5 text-yellow-500 absolute opacity-0 dark:opacity-100 transition-opacity duration-200" />
      <Moon className="w-5 h-5 text-gray-700 dark:text-gray-300 opacity-100 dark:opacity-0 transition-opacity duration-200" />
    </button>
  )
}
